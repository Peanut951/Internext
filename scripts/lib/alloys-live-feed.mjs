...
export const mergeAlloysLivePricing = (products, liveItems) => {
  ...
  return products.map((product) => {
    ...
    return {
      ...
      weightKg: live.weightKg ?? product.weightKg ?? null,
      heightCm: live.heightCm ?? product.heightCm ?? null,
      widthCm: live.widthCm ?? product.widthCm ?? null,
      depthCm: live.depthCm ?? product.depthCm ?? null,
