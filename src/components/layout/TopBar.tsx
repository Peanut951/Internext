    ...
    <div className="bg-primary text-primary-foreground">
      <div className="container-wide flex items-center justify-between gap-3 text-sm">
        <div className="flex min-w-0 items-center gap-3 sm:gap-6">
          <Link to="/contact" className="flex min-h-11 items-center gap-2 transition-colors hover:text-accent">
          ...
          <Link to="/contact" className="hidden min-h-11 min-w-0 items-center gap-2 transition-colors hover:text-accent sm:flex">
        ...
        <div className="flex shrink-0 items-center gap-2 sm:gap-4">
          {session ? (
            ...
            <>
              <Button variant="accent" size="sm" className="h-11 gap-2 px-3" asChild>
                <Link to="/login">
